...
def plot_results(data, save_path) -> None:
    ...
    plt.plot(
        data["pressures"], data["ex_ones_square"], label="Square ext lands"
    )
    plt.plot(
        data["pressures"], data["in_ones_square"], label="Square int lands"
    )
	...
	x_data_set1, x_data_set2, x_data_set3, x_data_set4, x_data_set5, x_data_set6, x_data_set7, x_data_set8, x_data_set9, x_data_set10 = np.split(data["half_regressions"][slice_begin:slice_end], 10)
	y_data_set1, y_data_set2, y_data_set3, y_data_set4, y_data_set5, y_data_set6, y_data_set7, y_data_set8, y_data_set9, y_data_set10 = np.split(data["lambdas"][slice_begin:slice_end], 10)
